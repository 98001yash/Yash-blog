    ...
    <LayoutWrapper>
      <section className="grid gap-10 pb-20 pt-10 lg:grid-cols-[1.3fr_0.7fr] lg:items-end">
        <div className="space-y-6">
          <p className="eyebrow">Portfolio · Blog · Systems Thinking</p>
          <div className="space-y-5">
            <h1 className="max-w-4xl text-5xl font-semibold leading-tight md:text-6xl">
              Designing fast, thoughtful web products with strong frontend architecture.
            </h1>
            <p className="max-w-2xl text-lg leading-8 text-slate-300">
              A production-grade portfolio platform for shipping case studies, engineering writing,
              and scalable content workflows powered by Next.js, TypeScript, Tailwind CSS, and MDX.
            </p>
          </div>
        ...
        <div className="panel p-6">
          ...
          <div className="mt-6 grid gap-4 sm:grid-cols-2 lg:grid-cols-1">
            {[
              'MDX-driven publishing with clean authoring workflows',
              'Static-first pages with dynamic metadata for SEO',
              'Reusable UI primitives built for long-term scale',
              'Thoughtful dark-mode interface for developer audiences',
            ].map((item) => (
